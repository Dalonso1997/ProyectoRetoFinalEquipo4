...
public class MenuModificar extends javax.swing.JDialog {
     ...
     * quiere editar.
     */
    public MenuModificar(java.awt.Frame parent, boolean modal, int idMaterial, String nombreMaterial, String descripcionMaterial) {
        super(parent, modal);
        initComponents();

        this.idMaterial = idMaterial;
        txtNuevo.setText(nombreMaterial);
        txtDescripcion.setText(descripcionMaterial);
