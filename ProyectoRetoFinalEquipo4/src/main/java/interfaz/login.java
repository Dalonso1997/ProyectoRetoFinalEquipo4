...
/**
 * Ventana principal para controlar el inicio de sesión de los usuarios en
...
public class login extends javax.swing.JFrame {
    ...
    /**
     * Constructor que configura las propiedades básicas del formulario de
     * login. Define el título de la barra superior, la acción de cierre
     * completo y centra la ventana.
     */
    public login() {
    ...
    private void initComponents() {
        ...
        Titulo.setBackground(new java.awt.Color(76, 76, 76));
        Titulo.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 204, 204), null));
        ...
        panelLogin.setBackground(new java.awt.Color(76, 76, 76));
        panelLogin.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 204, 204), null));
    ...
    /**
     * Captura las entradas del login y valida los datos con la base de datos de
     * MySQL. Si la cuenta existe, cierra esta pantalla y abre el menú adecuado
     * según los privilegios del rol.
     *
     * * @param evt evento de accion originado por pulsar el boton continuar.
     */
     ...
     * iniciar el hilo visual del formulario.
     *
     * * @param args argumentos de ejecucion por consola.
     */
