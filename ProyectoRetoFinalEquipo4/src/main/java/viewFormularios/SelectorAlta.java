...
public class SelectorAlta extends javax.swing.JDialog {
    ...
    public SelectorAlta(java.awt.Frame parent, boolean modal) {
        ...
        selectorMaterial.removeAllItems();

        if (materiales.isEmpty()) {
            selectorMaterial.addItem(new Material(0, "No hay material para dar de alta", "", 0, 0, null, 0, 0));
        } else {
    ...
    private void bntAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntAceptarActionPerformed
        ...
        if (seleccionado == null || seleccionado.getId_material() == 0) {
            JOptionPane.showMessageDialog(this, "No hay material para dar de alta");
            return;
        }
        MaterialDAO dao = new MaterialDAO();
